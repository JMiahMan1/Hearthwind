...
// 26.2: mirrors vinery DrinkBlockItem. Food effects now live on Consumable, so
// drink effects apply manually in finishUsingItem via an effect supplier;
// tooltips read WineYears component data instead of FoodProperties effects.

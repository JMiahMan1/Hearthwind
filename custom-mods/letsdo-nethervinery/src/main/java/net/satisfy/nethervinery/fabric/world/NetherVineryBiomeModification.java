...
public class NetherVineryBiomeModification {
    ...
    public static void init() {
        BiomeModification world = BiomeModifications.create(NetherVineryIdentifier.of("world_features"));
    ...
    private static Predicate<BiomeSelectionContext> getVinerySelector(String path) {
        return BiomeSelectors.tag(TagKey.create(Registries.BIOME, NetherVineryIdentifier.of(path)));
    }

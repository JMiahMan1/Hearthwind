...
// 26.2: Architectury @ExpectPlatform transformer is absent from
// architectury-fabric 21.0.7; PlatformHelperImpl bodies are inlined here
// (single-loader Fabric port, no NeoForge split needed).

...
public class DogEatFromBowlGoal extends Goal {
    ...
    public void tick() {
        ...
        if (distSqr <= 4.0F) {
            ...
            if (!level.isClientSide() && eatTicks <= 40) {
                ...
                if (eatTicks % 10 == 0) {
                    level.playSound(null, dog.blockPosition(), net.satisfy.farm_and_charm.core.util.PetSounds.wolfGrowl(dog), SoundSource.NEUTRAL, 0.4F, 0.4F);
                }
            }
            ...
            if (eatTicks == 40) {
                ...
                if (!level.isClientSide()) {
                    ...
                    level.playSound(null, dog.blockPosition(), net.satisfy.farm_and_charm.core.util.PetSounds.wolfPant(dog), dog.getSoundSource(), 0.4F, 0.4F);
    ...
    private ParticleOptions getParticleFromFood() {
        ...
        return new ItemParticleOption(ParticleTypes.ITEM, new net.minecraft.world.item.ItemStackTemplate(foodStack.getItem(), foodStack.getComponentsPatch()));
    }
}

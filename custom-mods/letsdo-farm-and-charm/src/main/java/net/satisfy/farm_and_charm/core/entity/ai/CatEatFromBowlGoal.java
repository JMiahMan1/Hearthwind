    ...
    public void tick() {
        ...
        if (distSqr <= 4.0F) {
            ...
            if (!level.isClientSide() && eatTicks <= 40) {
                ...
                if (eatTicks % 10 == 0) {
                    level.playSound(null, cat.blockPosition(), net.satisfy.farm_and_charm.core.util.PetSounds.catEat(cat), SoundSource.NEUTRAL, 0.8F, 1.0F);
                }
            }
            ...
            if (eatTicks == 40) {
                ...
                if (!level.isClientSide()) {
                    ...
                    level.playSound(null, cat.blockPosition(), net.satisfy.farm_and_charm.core.util.PetSounds.catPurr(cat), cat.getSoundSource(), 1.0F, 1.0F);

...
public class MobEffectRegistry {
    ...
    public static final Identifier HORSE_FODDER = FarmAndCharm.identifier("horse_fodder");
    public static final Identifier DOG_FOOD = FarmAndCharm.identifier("dog_food");
    public static final Identifier CLUCK = FarmAndCharm.identifier("cluck");
    public static final Identifier GRANDMAS_BLESSING = FarmAndCharm.identifier("grandmas_blessing");
    public static final Identifier RESTED = FarmAndCharm.identifier("rested");
    public static final Identifier FARMERS_BLESSING = FarmAndCharm.identifier("farmers_blessing");
    public static final Identifier SUSTENANCE = FarmAndCharm.identifier("sustenance");
    public static final Identifier SATIATION = FarmAndCharm.identifier("satiation");
    public static final Identifier FEAST = FarmAndCharm.identifier("feast");
    ...
    public static MobEffectInstance inst(Identifier id, int duration) {

...
public class StoveGuiHandler extends AbstractContainerMenu {
    ...
    private final net.minecraft.world.entity.player.Player playerRef;

    private boolean isFuel(ItemStack stack) {
        // 26.2: AbstractFurnaceBlockEntity.isFuel removed; same fuel check via level FuelValues.
        if (stack.isEmpty() || playerRef == null) return false;
        return playerRef.level().fuelValues().isFuel(stack);
    }
    ...
    private void buildBlockEntityContainer(Inventory playerInventory) {
        ...
        this.addSlot(new ExtendedSlot(inventory, 4, 42, 48, stack -> isFuel(stack)));

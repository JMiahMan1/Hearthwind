...
// 26.2: HumanoidModel works on HumanoidRenderState; the old
// copyPropertiesTo/young/setAllVisible/copyFrom helpers are gone.
// Pose copying is handled by ArmorRenderer.submitTransformCopyingModel;
// this class keeps the dungarees geometry plus its visible parts.
public class DungareesLeggingsModel extends HumanoidModel<HumanoidRenderState> {

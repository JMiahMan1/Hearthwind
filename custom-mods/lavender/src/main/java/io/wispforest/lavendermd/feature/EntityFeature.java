        ...
        registrar.registerToken((nibbler, tokens) -> {
            ...
            try {
                ...
                if (nbtIndex != -1) {
                    ...
                    nbt = net.minecraft.nbt.TagParser.parseCompoundFully(entityString.substring(nbtIndex));
                    entityString = entityString.substring(0, nbtIndex);
                }

                var entityType = BuiltInRegistries.ENTITY_TYPE.getOptional(Identifier.tryParse(entityString)).orElseThrow();

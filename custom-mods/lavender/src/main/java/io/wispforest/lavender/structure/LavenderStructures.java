...
import io.wispforest.lavender.book.ResourceFinder;
...
public class LavenderStructures {
    ...
    public static void initialize() {
        ResourceManagerHelper.get(net.minecraft.server.packs.PackType.CLIENT_RESOURCES).registerReloadListener(new ReloadListener());

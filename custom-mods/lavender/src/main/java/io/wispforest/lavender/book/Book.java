...
public final class Book {
    ...
    private final @Nullable Component dynamicBookName;
    ...
    public Book(
        ...
        @Nullable Component dynamicBookName,
    ...
    public @Nullable Entry entryByAssociatedItem(ItemStack associatedStack) {
        ...
        for (var candidateEntry : candidates) {
            for (var candidateAssociatedStack : candidateEntry.associatedItems()) {
                if (ItemStack.isSameItemSameComponents(candidateAssociatedStack, associatedStack)) {
    ...
    public @Nullable Component dynamicBookName() {
    ...
    public record ToastSettings(ItemStack iconStack, Component bookName, @Nullable Identifier backgroundSprite) {}
}

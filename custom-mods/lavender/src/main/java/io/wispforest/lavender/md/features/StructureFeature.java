        ...
        protected void visitStart(MarkdownCompiler<?> compiler) {
            ...
            if (layerSlider != null) {
                layerSlider.max(0).min(this.structure.ySize).tooltipSupplier(layer -> {
                    return layer > 0
                            ? Component.translatable("text.lavender.structure_component.layer_tooltip", layer.intValue())
                            : Component.translatable("text.lavender.structure_component.all_layers_tooltip");

...
// through a baked part model, text through the collector.
@Environment(EnvType.CLIENT)
public class PineSignRenderer<T extends PineSignBlockEntity, S extends PineSignRenderer.State> implements BlockEntityRenderer<T, S> {
    private static final int OUTLINE_RENDER_DISTANCE = Mth.square(16);
    private static final Vec3 TEXT_OFFSET = new Vec3(0.0, 0.3333333432674408, 0.046666666865348816);
    private static final Identifier TEXTURE =
            Identifier.fromNamespaceAndPath(Meadow.MOD_ID, "textures/entity/signs/pine.png");
    public static final net.minecraft.client.model.geom.ModelLayerLocation LAYER_LOCATION =
            new net.minecraft.client.model.geom.ModelLayerLocation(Meadow.identifier("pine_sign"), "main");
    ...
    public PineSignRenderer(BlockEntityRendererProvider.Context context) {

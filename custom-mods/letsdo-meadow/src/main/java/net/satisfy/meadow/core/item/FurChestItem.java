...
public class FurChestItem extends Item {
    private final ArmorType type;
    private final Identifier chestplateTexture;

    public FurChestItem(Holder<ArmorMaterial> armorMaterial, ArmorType type, Properties properties, Identifier chestplateTexture) {

...
public class WaterBuffaloModel extends QuadrupedModel<LivingEntityRenderState> {
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        PartDefinition head_r2 = head.addOrReplaceChild("head_r2", CubeListBuilder.create().texOffs(0, 0).addBox(-0.6F, -1.5F, -2.0F, 1.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.5F, 1.1607F, -3.0F, 0.0F, 0.0F, -0.48F));

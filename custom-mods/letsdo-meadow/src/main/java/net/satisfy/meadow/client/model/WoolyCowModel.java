...
import net.satisfy.meadow.client.renderer.entity.WoolyCowRenderState;

@SuppressWarnings("rawtypes")
public class WoolyCowModel extends CowModel {
    ...
    public void setupAnim(LivingEntityRenderState state) {
        ...
        if (state instanceof WoolyCowRenderState wooly) {
            getHead().y = 6.0f + wooly.neckAngle * 9.0f;
            getHead().xRot = wooly.headAngle;
        }
    }
}

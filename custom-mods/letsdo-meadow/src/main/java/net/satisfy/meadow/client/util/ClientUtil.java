...
public class ClientUtil {
    ...
    /** Backwards-compatible overload used by block-entity state dispatch. */
    public static void renderBlockFromItem(BlockItem item, PoseStack matrices,
            SubmitNodeCollector collector, BlockModelResolver blockResolver, BlockEntity entity) {
        renderBlockFromItem(item, matrices, collector, blockResolver, entity.getLevel(), entity.getBlockPos());
    }

    /** Backwards-compatible overload used by block-entity state dispatch. */
    public static void renderBlock(BlockState state, PoseStack matrices, SubmitNodeCollector collector,
            BlockModelResolver blockResolver, BlockEntity entity) {
        renderBlock(state, matrices, collector, blockResolver, entity.getLevel(), entity.getBlockPos());
    }
}

...
public class FurBootsRenderer implements ArmorRenderer {
    ...
    public void render(PoseStack matrices, SubmitNodeCollector collector, ItemStack stack, HumanoidRenderState renderState, EquipmentSlot slot, int light, HumanoidModel<HumanoidRenderState> contextModel) {
        ...
        FurBootsModel model = ArmorRegistry.getBootsModel(furBootsItem, contextModel.rightLeg, contextModel.leftLeg);

        Identifier baseTexture = furBootsItem.getBootsTexture();

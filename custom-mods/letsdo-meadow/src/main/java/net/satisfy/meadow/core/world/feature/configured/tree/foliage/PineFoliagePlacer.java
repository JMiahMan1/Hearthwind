...
public class PineFoliagePlacer extends FoliagePlacer {
    ...
    @Override
    protected void createFoliage(@NotNull WorldGenLevel level, @NotNull FoliageSetter setter, @NotNull RandomSource random, @NotNull TreeConfiguration config, int trunkHeight, @NotNull FoliageAttachment attachment, int foliageHeight, int radius, int topOffset) {
    ...
    private void placeRing(WorldGenLevel level, FoliageSetter setter, RandomSource random, TreeConfiguration config, BlockPos center, int ringRadius, int relativeY, boolean doubleTrunk, int layerIndex, RandomSource rng) {

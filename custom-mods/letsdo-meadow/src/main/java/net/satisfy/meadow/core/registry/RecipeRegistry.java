...
import net.satisfy.meadow.core.recipes.*;
...
public class RecipeRegistry {
    ...
    public static final RegistrySupplier<RecipeSerializer<CookingCauldronRecipe>> COOKING_SERIALIZER = create("cooking", () -> CookingCauldronRecipe.Serializer.SERIALIZER);

    public static final RegistrySupplier<RecipeType<CheeseFormRecipe>> CHEESE = create("cheese");
    public static final RegistrySupplier<RecipeSerializer<CheeseFormRecipe>> CHEESE_SERIALIZER = create("cheese", () -> CheeseFormRecipe.Serializer.SERIALIZER);
    public static final RegistrySupplier<RecipeType<WoodcuttingRecipe>> WOODCUTTING = create("woodcutting");
    public static final RegistrySupplier<RecipeSerializer<WoodcuttingRecipe>> WOODCUTTING_SERIALIZER = create("woodcutting", () -> WoodcuttingRecipe.Serializer.SERIALIZER);
    public static final RegistrySupplier<RecipeType<FeltingRecipe>> FELTING = create("felting");
    public static final RegistrySupplier<RecipeSerializer<FeltingRecipe>> FELTING_SERIALIZER = create("felting", () -> FeltingRecipe.Serializer.SERIALIZER);

...
public class FlowerPotBigBlock extends StorageBlock {
    ...
    public boolean canInsertStack(ItemStack stack) {
        return (stack.getItem() instanceof net.minecraft.world.item.BlockItem blockItem && blockItem.getBlock() instanceof net.minecraft.world.level.block.DoublePlantBlock);
    }

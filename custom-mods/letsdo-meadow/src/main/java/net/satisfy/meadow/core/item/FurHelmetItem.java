...
public class FurHelmetItem extends Item {
    private final ArmorType type;
    private final Identifier hatTexture;

    public FurHelmetItem(Holder<ArmorMaterial> armorMaterial, ArmorType type, Properties properties, Identifier hatTexture) {

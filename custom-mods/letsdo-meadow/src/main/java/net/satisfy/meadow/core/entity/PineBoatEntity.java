...
public class PineBoatEntity extends Boat {
    ...
    public PineBoatEntity(EntityType<? extends Boat> type, Level level) {
        super(type, level, ObjectRegistry.PINE_BOAT);
    ...
    protected void readAdditionalSaveData(net.minecraft.world.level.storage.ValueInput input) {
        ...
        this.setWoodType(Type.byName(input.read("Type", com.mojang.serialization.Codec.STRING).orElse("pine")));
    }
    ...
    public enum Type {
        ...
        public Identifier getTexture(boolean hasChest) {
            if (hasChest) {
                return Identifier.fromNamespaceAndPath(Meadow.MOD_ID, "textures/entity/chest_boat/" + name + ".png");
            }
            return Identifier.fromNamespaceAndPath(Meadow.MOD_ID, "textures/entity/boat/" + name + ".png");
        }

...
public class DarkBrewEntity extends ThrowableItemProjectile {
    ...
    public DarkBrewEntity(Level world, LivingEntity owner) {
        super(EntityTypeRegistry.DARK_BREW.get(), owner, world, new ItemStack(ObjectRegistry.DARK_BREW.get()));
    }
    ...
    private ParticleOptions getParticleParameters() {
        ...
        ParticleOptions particle = itemStack.isEmpty() ? ParticleTypes.LANDING_HONEY : new ItemParticleOption(ParticleTypes.ITEM, ItemStackTemplate.fromNonEmptyStack(itemStack));
    ...
    protected void onHitEntity(EntityHitResult entityHitResult) {
        ...
        if (this.level() instanceof ServerLevel serverLevel) {
            ...
            int damage = 2;
            entity.hurtServer(serverLevel, entity.damageSources().thrown(this, this.getOwner()), (float) damage);
        }
    }
    ...
    protected void onHit(HitResult hitResult) {
        ...
        if (this.level() instanceof ServerLevel serverLevel) {
            ...
            beerElemental.snapTo(this.getX(), this.getY(), this.getZ(), this.getYRot(), this.getXRot());
            serverLevel.addFreshEntity(beerElemental);

...
public class BeerElementalAttackEntity extends AbstractHurtingProjectile {
    ...
    private void playCreationSound() {
        ...
        this.level().playSound(null, x, y, z, soundEvent, this.getSoundSource(), 1.0F, 1.0F);
    }
    ...
    protected void onHitEntity(EntityHitResult entityHitResult) {
        ...
        if (this.level() instanceof ServerLevel serverLevel) {
            ...
            entity.hurtServer(serverLevel, entity.damageSources().thrown(this, this.getOwner()), 6.0F);
        }
    }

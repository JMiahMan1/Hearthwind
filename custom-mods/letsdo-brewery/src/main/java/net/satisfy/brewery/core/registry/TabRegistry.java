...
public class TabRegistry {
    ...
    public static final RegistrySupplier<CreativeModeTab> BREWERY_TAB = CREATIVE_MODE_TABS.register("brewery", () -> CreativeModeTab.builder(CreativeModeTab.Row.TOP, 1)
            .icon(() -> new ItemStack(dev.jmiahman.hearthwind.survival.Sobriety.alcoholRemoved() ? ObjectRegistry.ROOT_BEER.get() : ObjectRegistry.BEER_WHEAT.get()))
            ...
            .displayItems((parameters, out) -> {
                ...
                out.accept(ObjectRegistry.WILD_HOPS.get());
                ...
                out.accept(ObjectRegistry.ROOT_BEER.get());
                out.accept(ObjectRegistry.SMALL_BEER.get());
                out.accept(ObjectRegistry.KVASS.get());

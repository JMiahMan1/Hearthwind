...
public class BrewfestBootsItem extends Item {
    private final ArmorType type;
    private final Identifier bootsTexture;

    public BrewfestBootsItem(Holder<ArmorMaterial> armorMaterial, ArmorType type, Properties properties, Identifier bootsTexture) {

...
public class BrewfestChestItem extends Item {
    private final ArmorType type;
    private final Identifier chestplateTexture;

    public BrewfestChestItem(Holder<ArmorMaterial> armorMaterial, ArmorType type, Properties properties, Identifier chestplateTexture) {

...
public class StorageTypeRegistry {
    public static final Identifier BEVERAGE = Brewery.identifier("beverage");
    ...
    public static Set<Block> registerBlocks(Set<Block> blocks) {
        ...
        blocks.addAll(List.of(
                ...
                ObjectRegistry.ROOT_BEER.get(), ObjectRegistry.SMALL_BEER.get(),
                ObjectRegistry.KVASS.get(), ObjectRegistry.COFFEE.get()
        ));
        return blocks;
    }
}

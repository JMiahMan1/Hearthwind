...
public class RecipeTypeRegistry {
    ...
    public static final RegistrySupplier<RecipeSerializer<BlankCakeInteractionRecipe>> BLANK_CAKE_INTERACTION_SERIALIZER = RECIPE_SERIALIZERS.register("blank_cake_interaction", () -> BlankCakeInteractionRecipe.Serializer.SERIALIZER);
    ...
    public static final RegistrySupplier<RecipeSerializer<BakingStationRecipe>> BAKING_STATION_RECIPE_SERIALIZER = create("baking_station", () -> BakingStationRecipe.Serializer.SERIALIZER);

 ...
 */
public final class AgedPrimitiveLoot {
    ...
    public static void init() {
            ...
            if (isBlockTable(key, Blocks.STONE.getLootTable())) {
                return LootTable.lootTable()
                        ...
                        .withPool(LootPool.lootPool()
                                ...
                                .add(LootItem.lootTableItem(AgedPrimitiveItems.ROCK)))
                        .build();
            }
            return null;
        });
        ...
        AgedPrimitive.LOGGER.info("aged-primitive: loot hooks installed (stone->rock, gravel bonus)");
    }

    private AgedPrimitiveLoot() {
    }
}

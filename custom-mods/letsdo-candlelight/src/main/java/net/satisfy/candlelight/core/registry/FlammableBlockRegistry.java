...
public class FlammableBlockRegistry {
    ...
    public static void init() {
        synchronized (FlammableBlockRegistry.class) {
    ...
    public static void addFlammable(int burnOdd, int igniteOdd, Block... blocks) {
        // FireBlock.setFlammable removed in 26.2 (now private/no-op); flammability handled via Properties
        for (Block block : blocks) {
            // No-op: modern 26.2 flammability is configured differently
        }
    }
}
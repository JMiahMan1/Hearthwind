...
public class RecipeTypeRegistry {
    ...
    public static final RegistrySupplier<RecipeSerializer<TeaKettleRecipe>> TEA_KETTLE_RECIPE_SERIALIZER = create("kettle_brewing", () -> TeaKettleRecipe.Serializer.SERIALIZER);
    public static final RegistrySupplier<RecipeType<CauldronRecipe>> CAULDRON_RECIPE_TYPE = create("cauldron_brewing");

    public static final RegistrySupplier<RecipeSerializer<CauldronRecipe>> CAULDRON_RECIPE_SERIALIZER = create("cauldron_brewing", () -> CauldronRecipe.Serializer.SERIALIZER);

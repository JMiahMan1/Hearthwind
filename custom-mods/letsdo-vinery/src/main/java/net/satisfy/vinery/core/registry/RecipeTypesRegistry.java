...
public class RecipeTypesRegistry {
    ...
    public static final RegistrySupplier<RecipeSerializer<FermentationBarrelRecipe>> FERMENTATION_BARREL_RECIPE_SERIALIZER = create("wine_fermentation", () -> FermentationBarrelRecipe.Serializer.SERIALIZER);
    ...
    public static final RegistrySupplier<RecipeSerializer<ApplePressMashingRecipe>> APPLE_PRESS_MASHING_RECIPE_SERIALIZER = create("apple_mashing", () -> ApplePressMashingRecipe.Serializer.SERIALIZER);
    ...
    public static final RegistrySupplier<RecipeSerializer<ApplePressFermentingRecipe>> APPLE_PRESS_FERMENTING_RECIPE_SERIALIZER = create("apple_fermenting", () -> ApplePressFermentingRecipe.Serializer.SERIALIZER);

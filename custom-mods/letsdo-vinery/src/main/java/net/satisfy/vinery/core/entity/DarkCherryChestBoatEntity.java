...
public class DarkCherryChestBoatEntity extends ChestBoat {
    ...
    public DarkCherryChestBoatEntity(EntityType<? extends ChestBoat> entityType, Level level) {
        super(entityType, level, ObjectRegistry.DARK_CHERRY_CHEST_BOAT);
    }
    ...
    protected void readAdditionalSaveData(net.minecraft.world.level.storage.ValueInput input) {
        ...
        this.setWoodType(DarkCherryBoatEntity.Type.byName(input.read("Type", com.mojang.serialization.Codec.STRING).orElse("dark_cherry")));
    }

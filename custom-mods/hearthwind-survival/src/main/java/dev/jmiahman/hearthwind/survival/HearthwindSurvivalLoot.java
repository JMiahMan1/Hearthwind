 ...
 */
public final class HearthwindSurvivalLoot {
    ...
    public static void init() {
        ...
        HearthwindSurvival.LOGGER.info("aged-survival: loot hooks installed (wolf pelt, bear fur)");
    }

    private HearthwindSurvivalLoot() {
    }
}

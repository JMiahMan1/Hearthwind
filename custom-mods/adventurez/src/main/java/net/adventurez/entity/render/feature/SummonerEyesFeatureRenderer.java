...
public class SummonerEyesFeatureRenderer extends RenderLayer<AdventureRenderState, SummonerModel> {
    private static final RenderType EYE_LAYER = RenderTypes.eyes(Identifier.fromNamespaceAndPath("adventurez", "textures/entity/feature/summoner_eyes_feature.png"));

    public SummonerEyesFeatureRenderer(RenderLayerParent<AdventureRenderState, SummonerModel> parent) {
        super(parent);
    }

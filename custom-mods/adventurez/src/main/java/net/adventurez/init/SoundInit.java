...
public class SoundInit {
    ...
    private static SoundEvent register(String id) {
        return Registry.register(BuiltInRegistries.SOUND_EVENT, AdventureMain.identifierOf(id), SoundEvent.createVariableRangeEvent(AdventureMain.identifierOf(id)));
    }

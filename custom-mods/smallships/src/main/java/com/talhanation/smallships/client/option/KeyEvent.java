...
public class KeyEvent {
    ...
    public static void onKeyInput(int key, int scanCode, int action, int modifiers) {
        ...
        if (player.getVehicle() instanceof GroundCannonEntity cannon) {
            ...
            } else if (ModGameOptions.ENTER_CANNON_BARREL_KEY.matches(InputConstants.getKey(new net.minecraft.client.input.KeyEvent(key, scanCode, modifiers))) && action == InputConstants.PRESS) {

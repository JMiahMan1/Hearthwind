...
public class DrakkarSailModel extends SailModel {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(Identifier.fromNamespaceAndPath(SmallShipsMod.MOD_ID, DrakkarEntity.ID + "_sail_model"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition sail = partdefinition.addOrReplaceChild("Sail", CubeListBuilder.create(), PartPose.offset(-14.0F, 25.0F, 0.0F));

		PartDefinition Sail_4 = sail.addOrReplaceChild("Sail_4", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition segel_1_7 = Sail_4.addOrReplaceChild("segel_1_7", CubeListBuilder.create(), PartPose.offsetAndRotation(8.5F, -11.0F, 20.5F, 0.0F, 1.5708F, 0.0F));

		PartDefinition cube_r87 = segel_1_7.addOrReplaceChild("cube_r87", CubeListBuilder.create().texOffs(86, 16).addBox(-60.0F, -39.0F, 16.6905F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r88 = segel_1_7.addOrReplaceChild("cube_r88", CubeListBuilder.create().texOffs(83, 13).addBox(-16.0F, -40.25F, 11.2888F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r89 = segel_1_7.addOrReplaceChild("cube_r89", CubeListBuilder.create().texOffs(83, 21).addBox(-16.0F, -43.5F, 4.75F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r90 = segel_1_7.addOrReplaceChild("cube_r90", CubeListBuilder.create().texOffs(89, 5).addBox(-16.0F, -44.0887F, -4.8822F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r91 = segel_1_7.addOrReplaceChild("cube_r91", CubeListBuilder.create().texOffs(85, 16).addBox(-60.0F, -40.9587F, -18.0289F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r92 = segel_1_7.addOrReplaceChild("cube_r92", CubeListBuilder.create().texOffs(93, 22).addBox(-60.0F, -38.7859F, -21.6372F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r93 = segel_1_7.addOrReplaceChild("cube_r93", CubeListBuilder.create().texOffs(89, 4).addBox(-60.0F, -1.0F, -2.5F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r94 = segel_1_7.addOrReplaceChild("cube_r94", CubeListBuilder.create().texOffs(89, 6).addBox(-60.0F, -32.7857F, -32.1293F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r95 = segel_1_7.addOrReplaceChild("cube_r95", CubeListBuilder.create().texOffs(93, 24).addBox(-60.0F, -34.7019F, 23.9822F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
		...
		PartDefinition rope_15 = segel_1_7.addOrReplaceChild("rope_15", CubeListBuilder.create(), PartPose.offsetAndRotation(38.0F, 0.0F, 18.0F, 1.3963F, 0.7941F, 1.7628F));
		...
		PartDefinition rope_16 = segel_1_7.addOrReplaceChild("rope_16", CubeListBuilder.create(), PartPose.offsetAndRotation(3.0F, 0.5F, 19.0F, 1.2654F, -0.7592F, -1.5708F));
		...
		PartDefinition Sail_3 = sail.addOrReplaceChild("Sail_3", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition Sail_2 = sail.addOrReplaceChild("Sail_2", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition Sail_1 = sail.addOrReplaceChild("Sail_1", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition Sail_0 = sail.addOrReplaceChild("Sail_0", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition ropes = sail.addOrReplaceChild("ropes", CubeListBuilder.create(), PartPose.offset(43.5F, -16.0F, 0.0F));
		...
		PartDefinition cube_r81 = rope_13.addOrReplaceChild("cube_r81", CubeListBuilder.create().texOffs(93, 22).addBox(34.5F, -0.5F, -17.5F, 15.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
				...
				.texOffs(93, 22).addBox(74.5F, -0.5F, -17.5F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
				...
				.texOffs(93, 22).addBox(22.5F, -1.75F, -17.5F, 11.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(93, 22).addBox(11.5F, -0.5F, -17.5F, 9.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 11.5F, 17.0F, 0.0F, 0.0F, -1.5708F));

		PartDefinition cube_r82 = rope_13.addOrReplaceChild("cube_r82", CubeListBuilder.create().texOffs(7, 20).addBox(-1.75F, -1.75F, -1.0F, 3.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -22.5F, 0.0F, 0.0F, 0.0F, -2.3562F));
		...
		PartDefinition cube_r85 = rope_14.addOrReplaceChild("cube_r85", CubeListBuilder.create().texOffs(7, 20).addBox(-1.75F, -1.75F, -1.0F, 3.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -22.5F, 0.0F, 0.0F, 0.0F, -2.3562F));

		PartDefinition cube_r86 = rope_14.addOrReplaceChild("cube_r86", CubeListBuilder.create().texOffs(12, 28).addBox(-1.5F, -1.5F, -1.0F, 3.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -10.5F, 0.0F, 0.0F, 0.0F, -2.3562F));

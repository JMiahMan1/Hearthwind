...
public class BriggModel extends ShipModel<BriggEntity> {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(Identifier.fromNamespaceAndPath(SmallShipsMod.MOD_ID, BriggEntity.ID + "_model"), "main");

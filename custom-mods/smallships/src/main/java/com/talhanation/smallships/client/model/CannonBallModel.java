...
public class CannonBallModel extends EntityModel<CannonBallRenderState> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(Identifier.fromNamespaceAndPath(SmallShipsMod.MOD_ID, "model_cannonball"), "main");

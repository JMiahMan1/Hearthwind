...
public class DyedCannonShootOptions implements ParticleOptions {
    ...
    public static final class Type extends ParticleType<DyedCannonShootOptions> {
        public Type() {
            super(false);
        }

        @Override
        public MapCodec<DyedCannonShootOptions> codec() {
            return MAP_CODEC;
        }

        @Override
        public StreamCodec<? super RegistryFriendlyByteBuf, DyedCannonShootOptions> streamCodec() {
            return STREAM_CODEC;
        }
    }
}

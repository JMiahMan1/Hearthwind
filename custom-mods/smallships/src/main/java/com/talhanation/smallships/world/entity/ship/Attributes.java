...
public class Attributes {
    ...
    public void loadSaveData(CompoundTag tag) {
        if (tag.contains("Attributes")) {
            CompoundTag compoundtag = tag.getCompound("Attributes").orElse(new CompoundTag());
            this.maxHealth = compoundtag.getFloat("maxHealth").orElse(0.0f);
            this.maxSpeed = compoundtag.getFloat("maxSpeed").orElse(0.0f);
            this.maxReverseSpeed = compoundtag.getFloat("maxReverseSpeed").orElse(0.0f);
            this.acceleration = compoundtag.getFloat("acceleration").orElse(0.0f);
            this.rotationAcceleration = compoundtag.getFloat("rotationAcceleration").orElse(0.0f);
            this.maxRotationSpeed = compoundtag.getFloat("maxRotationSpeed").orElse(0.0f);
            this.friction = compoundtag.getFloat("friction").orElse(0.0f);
        }
    }
